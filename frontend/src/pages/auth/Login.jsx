        ...
        <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
            ...
            <div className="flex flex-col gap-4">
                <input
                    ...
                    required
                    className="w-full bg-slate-900/70 text-white placeholder-slate-500 border border-slate-700 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                />
                <input
                    type="password"
                ...
                <button
                    onClick={handleLogin}
                    className="w-full bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white font-semibold rounded-xl py-3 text-sm transition-all duration-150 shadow-lg shadow-indigo-900/40 mt-2"
                >
                    Login
                </button>
            </div>
