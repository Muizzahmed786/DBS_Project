    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="px-8 py-8 flex justify-center">
        <form
          ...
          className="w-full max-w-3xl bg-slate-800/50 border border-slate-700/60 rounded-2xl p-8 flex flex-col gap-6"
        >
          ...
          <div>
            ...
            <textarea
              ...
              rows="3"
              className="w-full px-4 py-2 rounded-lg border border-slate-700/60 bg-slate-900/60 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500/60"
            />
          </div>
